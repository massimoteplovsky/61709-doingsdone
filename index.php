...
// $task_list = [["Задачи" => "Собеседование в IT компании", "" "Выполнить тестовое задание", "Сделать задание первого раздела", "Встреча с другом", "Купить корм для кота", "Заказать пиццу"]], ["Дата выполнения" => ["01.06.2018", "25.05.2018", "21.04.2018", "22.04.2018", "Нет", "Нет"]], ["Категория" => ["Работа", "Работа", "Учеба", "Входящие", "Домашние дела", "Домашние дела"]], ["Выполнен" => ["Нет", "Нет", "Да", "Нет", "Нет", "Нет"]]];
                ...
                <main class="content__main">
                    ...
                    <div class="tasks-controls">
                        ...
                        <label class="checkbox">
                            ...
                            <input id="show-complete-tasks" class="checkbox__input visually-hidden" type="checkbox" <?php $show_complete_tasks ? print("checked") : print("")?>>
                    ...
                    <table class="tasks">
                        ...
                        <?php foreach ($task_list as $key => $value) :?>
                            <tr class="<?php $value['Выполнен'] ? print("tasks__item task task--completed") : print("tasks__item task") ?>">
                                <td class="task__select">
                                    <label class="checkbox task__checkbox">
                                        <input class="checkbox__input visually-hidden" type="checkbox">
                                        <span class="checkbox__text"><?php echo $value["Задача"]; ?></span>
                                    </label>
                                </td>

                                <td class="task__date" >
                                    <!--выведите здесь дату выполнения задачи-->
                                    <?php echo $value["Дата выполнения"]; ?>
                                </td>
